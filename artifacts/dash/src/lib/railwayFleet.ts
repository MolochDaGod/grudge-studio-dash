...
export const RAILWAY_FLEET: RailwayFleetEntry[] = [
  {
    ...
    service: "grudge-api",
    hostname: "grudge-api-production-0d46.up.railway.app",
    healthPath: "/api/health",
    repo: "MolochDaGod/Grudge-Builder",
    game: "Warlords",
    purpose:
      "Canonical game API — Railway Postgres SSOT (characters, bag, islands, wallet) + Colyseus rooms.",
    status: "canonical",
    action: "KEEP — this is the modern Warlords backend. Do not point clients at api.grudge-studio.com.",
    notes: "Also /api/colyseus/health and /api/multiplayer/status.",
  },
  {
    id: "the-engine",
    project: "The-Engine",
    service: "The-ENGINE",
    hostname: "the-engine.up.railway.app",
    healthPath: "/api/health",
    repo: "MolochDaGod/The-ENGINE",
    game: "Portal / Rec0deD",
    purpose: "Portal API — scores, challenges, GBUX, Treaty chat.",
    status: "canonical",
    action: "KEEP — grudge-studio.com /api/* rewrites here",
  },
  {
    id: "nexus-api",
  ...
  },
  {
    ...
    healthPath: "/health",
    repo: "Grudge-Warlords/grudge-pvp-server",
    game: "Warlords PvP",
    purpose: "Dedicated Socket.io 1v1 lobby — rooms, pick, ready, input. MySQL optional.",
    status: "canonical",
    action: "KEEP — repaired Aug 2026 (healthcheck, lockfile, CORS). Do not use world.grudge-studio.com.",
    notes: "/health, /api/health, /lobby. world.grudge-studio.com is dead.",
  },
  {
    id: "warlords-builder",
  ...
  },
  {
    ...
    repo: "Grudge-Warlords/grudge-studio-backend (archived)",
    game: "Warlords",
    purpose: "Legacy Warlords VPS microservices — superseded by grudge-backend + GrudgeBuilder Railway.",
    status: "deprecated",
    action: "DELETE Railway project — VPS stack retired",
  },
  {
    id: "rts-grudge",
    project: "rts-grudge",
  ...
  },
  {
    ...
    project: "DudeGolf",
    service: "(unlinked)",
    purpose: "Stale Railway project — unrelated to current fleet.",
    status: "deprecated",
